...
const MedicalAndLooting = ({ activePage, setActivePage }) => activePage === 'Medical and Looting' && (
  <>
    <RulesHeader>Medical (Healing) and Looting</RulesHeader>
    <TextBody>Bleed out</TextBody>
    <TextBody>
...
export default MedicalAndLooting;
